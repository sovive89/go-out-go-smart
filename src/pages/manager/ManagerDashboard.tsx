      ...
      <header className="sticky top-0 z-50 glass border-b border-border/30">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {role === 'admin' && (
              <>
                <Button variant="outline" size="sm" onClick={() => navigate('/staff/relatorios')} className="rounded-xl gap-1.5 h-8 text-xs border-primary/30 text-primary">
        ...
        {tab === 'pedidos' && (
          <>
            ...
            {(role === 'admin' || role === 'kitchen' || role === 'attendant') && (
              <Button variant="outline" onClick={() => navigate('/staff/cozinha')} className="rounded-xl gap-1.5 border-primary/30 text-primary">
